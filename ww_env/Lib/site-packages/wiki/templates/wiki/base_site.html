...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      ...
      <a class="navbar-brand" href="{% url 'wiki:root' %}">Wikiward</a>
      {% endblock %}
  ...
  <div class="container" style="margin-top: 60px;">
    ...
    <footer id="wiki-footer">
      ...
      <a href="https://github.com/django-wiki/django-wiki" class="float-right"><img src="{% static "
          wiki/img/github_icon.png" %}" /></a>
      {% endblock %}
